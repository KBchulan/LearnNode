...
PROTOBUF_CONSTEXPR Book::Book(::_pbi::ConstantInitialized)
    ...
    : ::google::protobuf::Message(Book_class_data_.base()),
...
static constexpr const ::_pb::EnumDescriptor**
    file_level_enum_descriptors_msgnode_2eproto = nullptr;
static constexpr const ::_pb::ServiceDescriptor**
    file_level_service_descriptors_msgnode_2eproto = nullptr;
const ::uint32_t
    TableStruct_msgnode_2eproto::offsets[] ABSL_ATTRIBUTE_SECTION_VARIABLE(
        protodesc_cold) = {
...
const char descriptor_table_protodef_msgnode_2eproto[] ABSL_ATTRIBUTE_SECTION_VARIABLE(
    protodesc_cold) = {
    "\n\rmsgnode.proto\"2\n\004Book\022\014\n\004name\030\001 \001(\t\022\r\n"
    "\005pages\030\002 \001(\005\022\r\n\005price\030\003 \001(\002b\006proto3"
};
static ::absl::once_flag descriptor_table_msgnode_2eproto_once;
PROTOBUF_CONSTINIT const ::_pbi::DescriptorTable descriptor_table_msgnode_2eproto = {
    false,
    false,
    75,
    descriptor_table_protodef_msgnode_2eproto,
    "msgnode.proto",
    &descriptor_table_msgnode_2eproto_once,
    nullptr,
    0,
    1,
    schemas,
    file_default_instances,
    TableStruct_msgnode_2eproto::offsets,
    file_level_enum_descriptors_msgnode_2eproto,
    file_level_service_descriptors_msgnode_2eproto,
};
// ===================================================================
...
class Book::_Internal {
 public:
  using HasBits =
      decltype(std::declval<Book>()._impl_._has_bits_);
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
    : ::google::protobuf::Message(arena, Book_class_data_.base()) {
#else   // PROTOBUF_CUSTOM_VTABLE
...
constexpr auto Book::InternalGenerateClassData_() {
  return ::google::protobuf::internal::ClassDataFull{
      ...
      &descriptor_table_msgnode_2eproto,
      nullptr,  // tracker
  };
}
...
PROTOBUF_CONSTINIT
    PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 const ::google::protobuf::internal::ClassDataFull
        Book_class_data_ =
            Book::InternalGenerateClassData_();

const ::google::protobuf::internal::ClassData* Book::GetClassData() const {
  ::google::protobuf::internal::PrefetchToLocalCache(&Book_class_data_);
  ::google::protobuf::internal::PrefetchToLocalCache(Book_class_data_.tc_table);
  return Book_class_data_.base();
}
...
const ::_pbi::TcParseTable<2, 3, 0, 17, 2> Book::_table_ = {
  {
    ...
    {::_pbi::TcParser::FastUS1,
     {10, 0, 0, PROTOBUF_FIELD_OFFSET(Book, _impl_.name_)}},
    // int32 pages = 2;
    {::_pbi::TcParser::SingularVarintNoZag1<::uint32_t, offsetof(Book, _impl_.pages_), 1>(),
     {16, 1, 0, PROTOBUF_FIELD_OFFSET(Book, _impl_.pages_)}},
    // float price = 3;
    {::_pbi::TcParser::FastF32S1,
     {29, 2, 0, PROTOBUF_FIELD_OFFSET(Book, _impl_.price_)}},
  }}, {{
    65535, 65535
  }}, {{
    // string name = 1;
    {PROTOBUF_FIELD_OFFSET(Book, _impl_.name_), _Internal::kHasBitsOffset + 0, 0,
    (0 | ::_fl::kFcOptional | ::_fl::kUtf8String | ::_fl::kRepAString)},
    // int32 pages = 2;
    {PROTOBUF_FIELD_OFFSET(Book, _impl_.pages_), _Internal::kHasBitsOffset + 1, 0,
    (0 | ::_fl::kFcOptional | ::_fl::kInt32)},
    // float price = 3;
    {PROTOBUF_FIELD_OFFSET(Book, _impl_.price_), _Internal::kHasBitsOffset + 2, 0,
...
PROTOBUF_ATTRIBUTE_INIT_PRIORITY2 static ::std::false_type
    _static_init2_ PROTOBUF_UNUSED =
        (::_pbi::AddDescriptors(&descriptor_table_msgnode_2eproto),
         ::std::false_type{});
