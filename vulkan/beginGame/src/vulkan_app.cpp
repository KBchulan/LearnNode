...
void VulkanApp::initWindow() {
    ...
    window = glfwCreateWindow(WIDTH, HEIGHT, "Vulkan CUDA Game", nullptr, nullptr);
...
void VulkanApp::createInstance() {
    ...
    appInfo.pApplicationName = "Vulkan CUDA Game";
...
void VulkanApp::createVertexBuffer() {
    // 创建三角形玩家
    vertices = {
        {{0.0f, -0.5f}, {1.0f, 0.0f, 0.0f}},  // 红色
        {{0.5f, 0.5f}, {0.0f, 1.0f, 0.0f}},   // 绿色
        {{-0.5f, 0.5f}, {0.0f, 0.0f, 1.0f}},  // 蓝色
    };
