...
namespace middleware
{
  ...
  public:
    ...
    // 彩色打印
    template <typename... Args>
    void print(const fmt::text_style &style, std::string_view format, Args &&...args)
    {
    ...
    // 日志级别打印
    template <typename... Args>
    void log(LogLevel level, const fmt::text_style &style, std::string_view format, Args &&...args)
    {
