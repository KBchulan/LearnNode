<template>
  ...
  <div>
    ...
    <button @[event1].stop="func1">这是一个按钮(@[]版)</button> <!-- 这个是@[]版,也就是我们的动态事件 -->
    <!-- v-on需要说一下，这个是会从自己这一层触发父级的同名事件的，我们可以对当前事件多一个.stop来阻止这个冒泡 -->

    <!-- 这里写一下v-bind，可以给元素绑定上一个属性，比如给div容器多上一个id一类的 -->
...
// 这里是setup语法糖，如果不使用，则需要使用export default
// 写一些js/ts代码
